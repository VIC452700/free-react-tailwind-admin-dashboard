...
const ConnectWalletModal = (props: any) => {
    ...
    const handleConnectWallet = (id: number) => {
        connect({ connector: connectors[id] });
        if (isConnected) {
            props.handleConnectWallet(address?.toString().slice(0,6)+"..."+address?.toString().slice(-5));
            props.setConnectNetwork(chain?.name);
            props.setConnectorId(id);
        }
    }

    return(
        <div className="modal absolute top-1/4 left-1/3 w-full max-w-sm p-4 bg-[#1f2937] border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
            <div className="relative w-full max-w-md max-h-full">
                ...
                <ul className="mt-4 space-y-3">
                    <li>
                        <button onClick={() => handleConnectWallet(0)} className="flex w-full items-center p-3 text-base font-bold text-white rounded-lg bg-[#4b5563] hover:bg-[#64748b] group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            ...
                            <span className="inline-flex items-center justify-center px-2 py-0.5 ml-36 text-xs font-medium text-gray-500 bg-[#374151] rounded dark:bg-gray-700 dark:text-gray-400">Popular</span>
                        </button>
                    </li>
                    <li>
                        <button onClick={() => handleConnectWallet(1)} className="flex w-full items-center p-3 text-base font-bold text-white rounded-lg bg-[#4b5563] hover:bg-[#64748b] group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            ...
                            <span className="ml-3 whitespace-nowrap">Coinbase Wallet</span>
                        </button>
                    </li>
                    <li>
                        <button onClick={() => handleConnectWallet(2)} className="flex w-full items-center p-3 text-base font-bold text-white rounded-lg bg-[#4b5563] hover:bg-[#64748b] group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                    ...
                    <li>
                        <button onClick={() => handleConnectWallet(3)} className="flex w-full items-center p-3 text-base font-bold text-white rounded-lg bg-[#4b5563] hover:bg-[#64748b] group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            ...
                            <span className="ml-3 whitespace-nowrap">Injected</span>
                        </button>
                    </li>
                </ul>
            </div>
